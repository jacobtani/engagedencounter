class OrganiserMailer < ApplicationMailer
  ...
  def send_enquiry(message:)
    ...
    data = { "to" => {"engagedencounterwelington@gmail.com"=>"Engaged Encounter Wellington"},
    "from" => [message.email, message.email],
    "replyto" => ["engagedencounterwelington@gmail.com","Engaged Encounter Wellington"],
  ...
  def new_registration(attendee:)
    ...
    data = { "to" => { "engagedencounterwelington@gmail.com" => "Engaged Encounter Wellington" },
       ...
       Preferred Weekend: " + attendee.preferred_event + "
       Fiance Full Name: " + attendee.fiance_full_name + "
       Wedding Date: " + attendee.wedding_date + "
